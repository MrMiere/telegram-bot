...
CHANNEL = "@thetopminers"  # ⚠️ این رو با نام واقعی کانالت عوض کن

# پورت برای health check (Render به این نیاز داره)
...
class HealthHandler(BaseHTTPRequestHandler):
    ...
    def log_message(self, format, *args):
        pass  # لاگ رو خاموش کن تا شلوغ نشه
...
def get_market():
    """دریافت قیمت بازار از Yahoo Finance"""
    symbols = {
        "GOLD": "GC=F",
        "DXY": "DX-Y.NYB",
        "BRENT": "BZ=F",
...
def run():
    ...
    health_thread.start()
    time.sleep(2)  # صبر برای بالا اومدن سرور
    ...
    while True:
        ...
        # هر 10 دقیقه یک بار (600 ثانیه)
        # اگه می‌خوای 5 دقیقه بشه، عدد رو بذار 300
        time.sleep(600)
